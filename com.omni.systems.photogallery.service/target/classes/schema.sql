...
DROP TABLE IF EXISTS `gallery_style_type`;

CREATE TABLE `gallery_style_type` (
  `gallery_style_id` int(11) NOT NULL AUTO_INCREMENT,
  `gallery_style_name` varchar(255) DEFAULT NULL,
  `gallery_style_description` varchar(255) DEFAULT NULL,
  `mime_type_group_id` int(11) NOT NULL,
  PRIMARY KEY (`gallery_style_id`)
) ENGINE=InnoDB AUTO_INCREMENT=0 DEFAULT CHARSET=utf8;
